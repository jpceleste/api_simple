<?php
    ...
    if(isset($user) && isset($pass) && isset($dni) && isset($nombre) && isset($apellido) && isset($mail)){
        $usuario = new DaoUsuario();
        $usuarios = $usuario->createUsuario($user,$pass,$dni,$nombre,$apellido,$mail);
        $records = $usuarios;
    }else{
        $status = "error";
        $message = "Los parámetros user, pass, dni, nombre, apellido y mail son requeridos.";
    }
